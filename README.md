...
- Tombol **"Jalankan otomatis"** pada antrean sebulan mencabut batas itu atas permintaan pemilik proyek: skrip mengisi, menekan Save, membuka Add, dan lanjut sendiri. Jumlah sekali jalan dipilih sendiri — 10, 20, 30, 40, atau semua — supaya ada titik henti untuk memeriksa hasilnya di KipApp sebelum melanjutkan; pilihannya diingat. Ia **berhenti total pada kegagalan pertama**, memakai menutupnya dialog sebagai bukti tersimpan (bukan teks notifikasi, yang bisa berganti), tidak menyimpan penanda "sudah pernah disimpan" (Anda bisa menghapus entri di KipApp kapan saja, jadi catatan semacam itu pasti salah cepat atau lambat), dan menyediakan tombol BERHENTI yang selalu terlihat. Konsekuensinya nyata: yang masuk ke sistem kinerja resmi bukan lagi yang Anda lihat, melainkan yang skrip anggap benar — pakai setelah mode manual terbukti bersih.
